    ...
    <section id="about" className="min-h-[70vh]">
      ...
      <div className="flex justify-center">
        <div className="flex w-1/2 flex-col items-center justify-center text-center">
          ...
          <p className="italic">
            Halo, nama saya Rakha atau bisa dikenal dengan alias populer saya, BlueTed. 
            Saya adalah seorang web developer dan game developer yang ingin menciptakan hal yang menarik untuk semua.
          </p>
        </div>
      </div>
    </section>
